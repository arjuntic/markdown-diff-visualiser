...
npm test                 # Run 129 tests (Mocha + Chai + fast-check)
...
> You can see the rendered diff by running "Markdown Diff Visualiser: Show Changes" from the command palette or right-clicking the file.
